...
<template>
  ...
  >
    ...
    <div
      :class="cn(
        'relative h-svh w-(--sidebar-width) bg-transparent transition-[width] duration-200 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] will-change-[width]',
    ...
    <div
      :class="cn(
        'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] will-change-[width] md:flex',
        side === 'left'
